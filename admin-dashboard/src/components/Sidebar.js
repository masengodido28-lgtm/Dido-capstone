 ...
 * Shows logo, nav links, main Airbnb link, and logged-in user info.
...
const Sidebar = () => {
  ...
  // Main Airbnb frontend
  const mainSiteUrl =
    'https://dido-airbnb-frontend.onrender.com';
      ...
      <div className="sidebar__footer">
        ...
        {user && (
          <>
            ...
            {/* Back to main Airbnb website */}
            <button
              className="sidebar__logout"
              onClick={() =>
                window.location.href = mainSiteUrl
              }
              aria-label="Back to Airbnb"
            >
              <FaHome size={16} />

              {!collapsed && (
                <span>Back to Airbnb</span>
              )}
            </button>
