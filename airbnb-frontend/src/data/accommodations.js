...
export const accommodations = [
  {
    ...
    description:
      'Stay in the heart of New York City in this beautiful modern apartment with stunning skyline views.',
    guests: 4,
    bedrooms: 2,
    bathrooms: 2,
...

  {
    ...
    type: 'Cottage',
    description:
      'A beautiful cosy cottage with stunning mountain and ocean views, minutes from the beach.',
    guests: 2,
    bedrooms: 1,
    bathrooms: 1,
...

  {
    ...
    type: 'Villa',
    description:
      'Experience Paris like royalty in this stunning luxury villa with private pool and chef service.',
    guests: 8,
    bedrooms: 4,
    bathrooms: 3,
...

  {
    ...
    type: 'Entire house',
    description:
      'Wake up to the sound of waves in this stunning beachfront house with direct beach access.',
    guests: 6,
    bedrooms: 3,
    bathrooms: 2,
    ...
    price: 240,
    host: 'Zanele',
    host_id: '6676f16fdace0e26aed41e82',
    weeklyDiscount: 8,
    cleaningFee: 60,
    serviceFee: 40,
    occupancyTaxes: 25,
...

  {
    ...
    type: 'Private room',
    description:
      'A comfortable private room in a vibrant London neighbourhood, steps from the tube.',
    guests: 2,
    bedrooms: 1,
    bathrooms: 1,
    ...
    price: 95,
    host: 'James',
    host_id: '6676f16fdace0e26aed41e83',
    weeklyDiscount: 0,
    cleaningFee: 20,
    serviceFee: 15,
    occupancyTaxes: 10,
...

  {
    ...
    type: 'Cabin',
    description:
      'Escape the city in this peaceful mountain cabin just outside Joburg with fireplace and hiking trails.',
    guests: 4,
    bedrooms: 2,
    bathrooms: 1,
    ...
    price: 150,
    host: 'Thabo',
    host_id: '6676f16fdace0e26aed41e84',
    weeklyDiscount: 12,
    cleaningFee: 40,
    serviceFee: 30,
    occupancyTaxes: 20,
...
export const locations = [
  ...new Set(accommodations.map((a) => a.location)),
];